...
namespace Identity.Infrastructure.Persistence
{
    public class IdentityDbContext : DbContext
    {
        ...
        // dotnet ef migrations add IdentityDB --project src/Identity/Identity.Infrastructure --startup-project src/Identity/Identity.API --output-dir Persistence/Migrations
